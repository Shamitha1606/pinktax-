...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AI Fair Pricing Analysis" },
      { name: "description", content: "AI-powered fair price intelligence for products." },
      { property: "og:title", content: "AI Fair Pricing Analysis" },
      { property: "og:description", content: "AI-powered fair price intelligence for products." },
